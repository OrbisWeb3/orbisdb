...
export const jupiterRawTx = [
  {
    ...
    meta: {
      ...
      innerInstructions: [
        ...
        },
        {
          ...
          instructions: [
            {
              accounts: [
                8, 22, 34, 23, 24, 25, 43, 26, 22, 22, 22, 22, 22, 22, 27, 29,
                0,
              ],
            ...
            {
              accounts: [8, 0, 12, 28, 13, 29, 14, 3, 15, 16, 36],
            ...
            {
              accounts: [39, 17, 0, 28, 30, 18, 19, 20, 21, 8, 40, 37, 41],
      ...
      postBalances: [
        616745129067, 3083280, 2039280, 70407360, 304957985, 2039280, 1141440,
        42272871443, 934087680, 1, 731913600, 1141440, 5435781, 7135899479386,
        2039280, 70407360, 70407360, 7231440, 2052430507530, 2039280, 1461600,
        2039280, 6124800, 23357760, 2039280, 2039280, 3591360, 2039280, 0,
        2039280, 24039280, 2039280, 459528411866, 1141440, 2240705782, 1141440,
        0, 23942400, 1141440, 0, 23942400, 23942400, 233373617815, 1141440, 0,
        1, 5566314148, 0, 36236822,
      ],
      postTokenBalances: [
        {
          accountIndex: 2,
      ...
      preBalances: [
        616745144067, 3083280, 2039280, 70407360, 304957985, 2039280, 1141440,
        42272871443, 934087680, 1, 731913600, 1141440, 5435781, 7135924846485,
        2039280, 70407360, 70407360, 7231440, 2052405140431, 2039280, 1461600,
        2039280, 6124800, 23357760, 2039280, 2039280, 3591360, 2039280, 0,
        2039280, 24039280, 2039280, 459528411866, 1141440, 2240705782, 1141440,
        0, 23942400, 1141440, 0, 23942400, 23942400, 233373617815, 1141440, 0,
        1, 5566314148, 0, 36236822,
    ...
    transaction: {
      message: {
        ...
        addressTableLookups: [
          {
            ...
            readonlyIndexes: [231, 24, 27, 16, 245, 47],
            writableIndexes: [200, 246, 242, 243, 247],
          },
          {
            accountKey: "G3yuYaJGF4EnGneYHmwvtMHKavXhqz5x5WVaCzzCJYpQ",
            readonlyIndexes: [214, 212, 211, 216],
            writableIndexes: [206, 215, 207, 213, 210],
          },
          {
            accountKey: "8C1prTGFgNwayEWY1U7JfUotySB4JpDLbp6BK1eQGjMH",
            readonlyIndexes: [133, 11],
            writableIndexes: [117, 144, 142, 118, 119],
          },
          {
            accountKey: "8fSv82wiDE5VX2ZztaQ3WKJE7nGwMcezBC9TL6jp4JgQ",
            readonlyIndexes: [26, 0, 28, 21, 8],
            writableIndexes: [24, 25, 29, 23, 10],
          },
        ],
        header: {
        ...
        instructions: [
          ...
          {
            accounts: [0, 28, 0, 32, 45, 8],
            data: "2",
            programIdIndex: 10,
          },
          {
            accounts: [0, 29, 0, 46, 45, 8],
            data: "2",
            programIdIndex: 10,
          },
          {
            accounts: [0, 30, 0, 42, 45, 8],
            data: "2",
            programIdIndex: 10,
          },
          {
            accounts: [
              8, 0, 27, 30, 11, 42, 11, 47, 11, 33, 8, 22, 34, 23, 24, 25, 43,
              26, 22, 22, 22, 22, 22, 22, 27, 29, 0, 35, 8, 0, 12, 28, 13, 29,
              14, 3, 15, 16, 36, 38, 39, 17, 0, 28, 30, 18, 19, 20, 21, 8, 40,
              37, 41,
            ],
          ...
          {
            accounts: [1, 2, 4, 0, 5, 30, 48, 31, 6, 7, 8, 42, 8, 45],
