...
export default class ERC20Interface {
    ...
    async loadTokenDetails() {
        try {
            ...
            console.log("Token details - Name:", this.name, "Symbol:", this.symbol, "Decimals:", this.decimals);
        } catch (error) {
    ...
    parse(event) {
        ...
        switch(event.event) {
            case "Transfer":
                model_id = "kjzl6hvfrbw6c6t3290d1fhjfgbhbxk6swjke201jnxlg2igxewtxk6epclxc99";
                content = {
                    type: "Transfer",
